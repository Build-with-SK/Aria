...
- **Research desk** — 3,300+ symbols across India (NSE), the UK (LSE), the US, and crypto: quote, fundamentals, news, sentiment, political-exposure flag, charts, multi-timeframe indicator scan, ATR-based entry/stop/target.
